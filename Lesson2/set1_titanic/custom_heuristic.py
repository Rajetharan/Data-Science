...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        if passenger_sex == 'male' and passenger_class == 1:     
            predictions[passenger_id] = 1

        if passenger_age < 18 and passenger_fare > mean_fare:
            predictions[passenger_id] = 1
...
file_path = "/Users/Rajetharan/Documents/DataScienceIntro/Lesson2/set1_titanic/titanic-data.csv"
print(custom_heuristic(file_path))
